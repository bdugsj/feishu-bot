...
available_setting = {
    ...
    "model": "gpt-4",  # 还支持 gpt-4, gpt-4-turbo, wenxin, xunfei, qwen
    ...
    "group_name_white_list": ["测试群聊"],  # 开启自动回复的群名称列表
    "group_name_keyword_white_list": [],  # 开启自动回复的群名称关键词列表
    "group_chat_in_one_session": ["测试群聊"],  # 支持会话上下文共享的群名称
